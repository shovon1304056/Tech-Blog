...
jQuery(function($){
    ...
    var modal = $('#wpr-deactivate-modal');
    var deactivateLink = '';


    $('#the-list').on('click', 'a.wpr-deactivate-link', function (e) {
        e.preventDefault();
        console.log('ansar');
    ...
    $('#wpr-deactivate-modal').on('click', 'a.review-and-deactivate', function (e) {
        e.preventDefault();
    ...
    modal.on('click', 'button.pipe-model-submit', function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'wpr_submit_uninstall_reason',
