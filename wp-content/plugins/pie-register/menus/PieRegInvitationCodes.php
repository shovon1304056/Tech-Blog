      ...
      <form method="post" action="">
        ...
        <ul>
          <li>
            <div class="fields">
              <p>
                <?php _e("Protect your privacy. If you want your blog to be exclusive, enable Invitation Codes to allow users to register by invitation only",'pie-register'); ?>
                .<br />
                <br />
          ...
          <li>
            <div class="fields"> <span class="quotation" style="margin-left:0px;">
              <?php _e("Set this to Yes if you want users to register when they use an invitation code you provide. To use Invitation codes, you will need to add the Invitation Code field to registration form in the form editor","pie-register");?>
              .</span> </div>
          </li>
          <li>
            <div class="fields fields_submitbtn">
              <input name="save_submit" class="submit_btn" value="<?php _e('Save Settings','pie-register');?>" type="submit" />
            </div>
          </li>
          <li>
            <div class="fields">
              ...
              :</strong>
              <?php _e("Each Code will be on a Separate Line.","pie-register");?>
              <br/>
              <?php _e("Special Characters are not allowed.","pie-register");?>
              </span> </div>
          </li>
          <li>
            <div class="fields">
