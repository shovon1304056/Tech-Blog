                	...
                	<?php if( function_exists( 'wp_nonce_field' )) wp_nonce_field( 'piereg_wp_deactivate_plugin_license_nonce','piereg_deactivate_plugin_license_nonce'); ?>    
                        ...
                        <div class="fields fields2">
                            ...
                            <input name="action" value="pie_reg_update" type="hidden" />
                          	<input type="submit" class="submit_btn" value=" <?php _e("Deactivate","pie-register");?> " onclick="return window.confirm('Are you sure you want to deactivate the plugin license?');" />
