...
class Edit_form_template extends Edit_form
{
	...
	function addPassword(){
		...
		$data .= '</div></li><li class="fields pageFields_'.$this->pages.' '.$topclass.'"><div class="fieldset"><label>'.__($this->field['label2'],"pie-register").'</label><div '.$fclass.'><input id="confirm_password_'.$this->id.'" type="password" class="input_fields '.$this->field['css'].' piereg_validate[equals['.$this->id.']]" placeholder="'.$this->field['placeholder2'].'" value="" name="confirm_password" autocomplete="off">';
	...
	function addName(){
		...
		$data .= '<div class="fieldset"><label>'.__($this->field['label'],"pie-register").'</label>';
		...
		if($this->label_alignment=="top")
			$topclass = "label_top"; 					
		$data .= '</div>';
		$data .= '<div class="fieldset"><label>'.__($this->field['label2'],"pie-register").'</label>';
