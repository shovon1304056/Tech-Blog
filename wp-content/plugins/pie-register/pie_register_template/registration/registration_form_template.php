...
class Registration_form_template extends Registration_form
{
	...
	function addPassword($fromwidget,$field_status = "")
	{
		...
		if( isset($this->field['required']) && $this->field['required'] != "" )
			...
			if($this->label_alignment=="top")
				$topclass = "label_top"; 
			$label2 = (isset($this->field['label2']) and !empty($this->field['label2']))? $this->field['label2'] : __("Confirm Password","pie-register");
			$data .= '</div>';
			//$data .= '</li>';
	...
	function addEmail($fromwidget)
	{
		...
		if(isset($this->field['confirm_email']))
		{
			...
			$data .= '</div>';
			$label2 = (isset($this->field['label2']) and !empty($this->field['label2']))? $this->field['label2'] : __("Confirm E-mail","pie-register");
			$data .= '<div class="fieldset">';
			$data .= '<label>'.$label2.$field_required.'</label>';
	...
	function addName()
	{
		...
		$data  = '<div class="fieldset">';
		$data .= '<label>'.__($this->field['label'],"pie-register") . $field_required . '</label>';
		...
		if($this->label_alignment=="top")
			$topclass = "label_top";
		$data .= '</div>';
		$label2 = (isset($this->field['label2']) and !empty($this->field['label2']))? $this->field['label2'] : __("Last Name","pie-register");
		$data .= '<div class="fieldset">';
		$data .= '<label>'.$label2 . $field_required .'</label>';
