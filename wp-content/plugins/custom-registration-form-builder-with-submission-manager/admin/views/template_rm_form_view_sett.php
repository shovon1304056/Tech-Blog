...
wp_localize_script('rm-form_presentation','pr_data',array('upload_btn_title'=>__('Choose Image','custom-registration-form-builder-with-submission-manager')));
    ...
    <div id="rm_styling_options" style="display:none">
        ...
        <div class="rm_pop_up_tab">
            ...
            <div id="rm_border_styling_options">
                ...
                <div class="rm_pop_up_row">
                    <label><?php _e('Border Radious', 'custom-registration-form-builder-with-submission-manager') ?> </label>
